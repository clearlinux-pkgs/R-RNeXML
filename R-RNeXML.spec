...
Version  : 2.4.9
Release  : 52
URL      : https://cran.r-project.org/src/contrib/RNeXML_2.4.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/RNeXML_2.4.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671232713
